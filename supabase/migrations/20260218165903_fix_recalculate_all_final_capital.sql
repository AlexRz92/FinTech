/*
  # Fix recalculate_all final capital calculation

  1. Problem: The function was not correctly getting the final capital from the last week
  2. Solution: Modify the function to properly retrieve and set the capital_net
*/
